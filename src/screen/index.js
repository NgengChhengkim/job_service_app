...
import CompleteRegistrationRecruiter from "./complete_registration";
...
export function RegisterScreen() {
  ...
  Navigation.registerComponent("complete_registration.index", () => CompleteRegistrationRecruiter, store, Provider)
